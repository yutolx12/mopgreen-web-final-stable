...
<script>
  ...
  var client2 = new Paho.MQTT.Client(host, port, "/ws",
    "myclientid_" + parseInt(Math.random() * 100, 10));

    // Menjalin koneksi antara client dan message broker
  client2.onConnectionLost = function () {
  ...
  client2.onMessageArrived = function (message) {
   ...
   // var water = {"twater1":twater1, "twater2":twater2};
   console.log(twater1);
   console.log(twater2);
   // int twater11 = twater1;
   // int twater22 = twater2;
   ...
   var loadingEle = $(".water1");
    ...
    setTimeout(function() {
      $(".water2").createWaterBall("updateRange", twater2);
    }, 1000);
  ...
  if (location.protocol == "https:") {
    options2.useSSL = true;
  }
  // var objwater = {"twater1": twater1, "twater2": twater2};
  //    console.log(objwater);
  client2.connect(options2);
  console.log("koneksi ke 20.20.0.245");
...
// }, 5000);
  switch12.addEventListener("change",()=>{
    if (switch12.checked == true) {
      ...
      var auto_identifier = "1";

      // Store JSON data in a JS variable
      var json = {"suhu_atas": suhu_atas, "suhu_bawah": suhu_bawah, "kelembapan_atas": kelembapan_atas, "kelembapan_bawah": kelembapan_bawah, "auto_identifier": auto_identifier};
